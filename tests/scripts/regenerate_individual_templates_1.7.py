...
This script regenerates the golden configs used by
test_generate_switch_config_aruba_templates_csm_1_7.py
"""
...
def main():
    """Regenerate all individual template golden configs and report results."""
    print("=" * 50)
