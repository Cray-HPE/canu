...
def test_switch_config_cdu_primary():
    ...
    with runner.isolated_filesystem():
        ...
        cmm = (
            ...
            "    no shutdown\n"
            "    description sw-cdu-001:2==>cmm000:1\n"
            "    no routing\n"
            ...
            "    no shutdown\n"
            "    description sw-cdu-001:3==>cmm001:1\n"
            "    no routing\n"
            "    vlan trunk native 2000\n"
            "    vlan trunk allowed 2000,3000,4091\n"
            "    spanning-tree root-guard\n"
            ...
            "    no shutdown\n"
            "    description sw-cdu-001:4==>cmm002:1\n"
            "    no routing\n"
            "    vlan trunk native 2000\n"
            "    vlan trunk allowed 2000,3000,4091\n"
            "    spanning-tree root-guard\n"
            ...
            "    no shutdown\n"
            "    description sw-cdu-001:5==>cmm003:1\n"
            "    no routing\n"
            "    vlan trunk native 2000\n"
            "    vlan trunk allowed 2000,3000,4091\n"
            "    spanning-tree root-guard\n"
        ...
        cec = (
            ...
            "    no shutdown\n"
            "    mtu 9198\n"
            "    description sw-cdu-001:1==>cec000:1\n"
            "    no routing\n"
            "    vlan access 3000\n"
            "    spanning-tree bpdu-guard\n"
            "    spanning-tree port-type admin-edge\n"
        ...
        mtn_hmn_vlan = (
            ...
            "interface vlan 3000\n"
            "    ip mtu 9198\n"
            "    ip address 192.168.106.0/22\n"
            "    active-gateway ip mac 12:00:00:00:73:00\n"
            "    active-gateway ip 192.168.106.1\n"
...
def test_switch_config_cdu_secondary():
    ...
    with runner.isolated_filesystem():
        ...
        cmm = (
            "interface lag 2 static\n"
            "    no shutdown\n"
            "    description sw-cdu-002:2==>cmm000:2\n"
            "    no routing\n"
            "    vlan trunk native 2000\n"
            "    vlan trunk allowed 2000,3000,4091\n"
            "    spanning-tree root-guard\n"
            ...
            "interface lag 3 static\n"
            "    no shutdown\n"
            "    description sw-cdu-002:3==>cmm001:2\n"
            "    no routing\n"
            "    vlan trunk native 2000\n"
            "    vlan trunk allowed 2000,3000,4091\n"
            "    spanning-tree root-guard\n"
            ...
            "interface lag 4 static\n"
            "    no shutdown\n"
            "    description sw-cdu-002:4==>cmm002:2\n"
            "    no routing\n"
            "    vlan trunk native 2000\n"
            "    vlan trunk allowed 2000,3000,4091\n"
            "    spanning-tree root-guard\n"
            ...
            "interface lag 5 static\n"
            "    no shutdown\n"
            "    description sw-cdu-002:5==>cmm003:2\n"
            "    no routing\n"
            "    vlan trunk native 2000\n"
            "    vlan trunk allowed 2000,3000,4091\n"
            "    spanning-tree root-guard\n"
...
def test_switch_config_switch_name_prompt():
    ...
    with runner.isolated_filesystem():
        ...
        assert "deny any 192.168.3.0/17 192.168.0.0/17" in str(result.output)
...
def test_switch_config_tds_spine_primary():
    """Test that the `canu switch config` command runs and returns valid TDS primary spine config."""
    with runner.isolated_filesystem():
        with open("sls_input_file.json", "w") as f:
            json.dump(sls_input, f)
...
def test_switch_config_tds_spine_secondary():
    """Test that the `canu switch config` command runs and returns valid TDS secondary spine config."""
    spine_secondary = "sw-spine-002"
...
def test_switch_config_tds_cdu_primary():
    """Test that the `canu switch config` command runs and returns valid tds primary cdu config."""
...
def test_switch_config_tds_cdu_secondary():
    """Test that the `canu switch config` command runs and returns valid tds secondary cdu config."""
...
def test_switch_config_tds_leaf_bmc():
    """Test that the `canu switch config` command runs and returns valid tds leaf-bmc config."""
