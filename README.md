...
- To run CANU inside a container:
  ...
  - Prerequisites:
    ...
    docker run -it --rm --net=host -v ${PWD}:/home/canu/mounted:rw --name canu-prod canu:<tag> canu validate shcd /home/canu/mounted/myshcd.xlsx
    ```
...
- Add a `canu-docker` wrapper command
