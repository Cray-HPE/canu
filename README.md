...
- [🛶 CANU](#-canu)
  ...
  - [Installation and Usage](#installation-and-usage)
    ...
    - [Generate Switch Config](#generate-switch-config)
      - [CSI Input](#csi-input-1)
      - [SLS API Input](#sls-api-input-1)
      - [Paddle / CCJ Input](#paddle--ccj-input)
      - [SHCD Input](#shcd-input)
      - [Generate Switch Configs Including Custom Configurations](#generate-switch-configs-including-custom-configurations)
      - [Generate Switch Config while preserving LAG #s](#generate-switch-config-while-preserving-lag-s)
    - [Generate Network Config](#generate-network-config)
      - [Generate Network Config With Custom Config Injection](#generate-network-config-with-custom-config-injection)
      - [Generate Network Config while preserving LAG #s](#generate-network-config-while-preserving-lag-s)
    - [Validate Switch Config](#validate-switch-config)
    - [Validate Network Config](#validate-network-config)
      - [File Output and JSON](#file-output-and-json)
    - [Cache](#cache)
  ...
  - [Changelog](#changelog)
    ...
    - [1.1.3](#113)
    - [1.1.2](#112)
    - [1.1.1 2022-12-07](#111-2022-12-07)
    - [0.0.6 - 2021-9-23](#006---2021-9-23)
    - [0.0.5 - 2021-5-14](#005---2021-5-14)
    - [0.0.4 - 2021-05-07](#004---2021-05-07)
    - [0.0.3 - 2021-04-16](#003---2021-04-16)
      - [Added](#added)
    - [0.0.2 - 2021-03-29](#002---2021-03-29)
      - [Added](#added-1)
    - [0.0.1 - 2021-03-19](#001---2021-03-19)
      - [Added](#added-2)
